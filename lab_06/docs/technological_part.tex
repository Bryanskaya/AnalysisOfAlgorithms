...
\qquadБыла написана специальная функция параметризации, ориентированная на проработки муравьиного алгоритма на разных наборах параметров. Её реализация указана в листинге \ref{code_auto}.
