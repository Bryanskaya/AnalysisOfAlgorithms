...
\begin{lstlisting}[label=code2, caption = Распараллеленный алгоритм Винограда (1 вариант)]
...
\begin{lstlisting}[label=code3, caption = Распараллеленный алгоритм Винограда (2 вариант)]
#include "parall_winograd.h"
